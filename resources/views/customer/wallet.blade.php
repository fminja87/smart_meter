            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                ...
                <div class="header-elements d-none">
                    <div class="breadcrumb justify-content-center">
                        <a class="breadcrumb-elements-item" data-toggle="modal" data-target="#modal_backdrop">
                ...
                <div class="card-body">
                    <ul class="nav nav-tabs nav-tabs-bottom border-bottom-0 nav-justified">
                        <li class="nav-item"><a href="#bottom-justified-divided-tab1" class="nav-link active"
                                                data-toggle="tab">Balance</a></li>
                        <li class="nav-item"><a href="#bottom-justified-divided-tab2" class="nav-link"
                                                data-toggle="tab">Last Deposit</a></li>
                        <li class="nav-item"><a href="#bottom-justified-divided-tab3" class="nav-link"
                                                data-toggle="tab">Last Withdraw</a></li>
                    </ul>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="bottom-justified-divided-tab1">
                            ...
                            <h1 align="center">Wallet Balance: {{ number_format($balance) }}</h1>
                        </div>
                        ...
                        <div class="tab-pane fade" id="bottom-justified-divided-tab2">
                            ...
                            @else
                                <h1 align="center">Latest Deposit: Time
                                    ({{ \Carbon\Carbon::parse($last_deposit->created_at)->diffForHumans() }}),
                                    Amount: {{ number_format($last_deposit->deposit) }}</h1>
                                <div align="center">
                                    <a href="{{ route('customer.wallet.deposit.history') }}">
                                        <small>Details</small>
                                    </a>
                                </div>
                            @endif
                        ...
                        <div class="tab-pane fade" id="bottom-justified-divided-tab3">
                            ...
                            @if($last_withdraw == null)
                                <h1 align="center">No Transaction</h1>
                            @else
                                <h1 align="center">Latest Withdraw: Date
                                    ({{ \Carbon\Carbon::parse($last_withdraw->created_at)->diffForHumans() }}),
                                    Amount: {{ number_format($last_withdraw->withdraw) }}</h1>
                                <div align="center">
                                    <a href="{{ route('customer.wallet.withdraw.history') }}">
                                        <small>Details</small>
                                    </a>
                                </div>
                            @endif
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">DEPOSIT ON WALLET</h5>
                        ...
                        <form action="{{ route('customer.wallet.deposit') }}" method="POST">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <input type="text" name="amount" id="amount" placeholder="Deposit Amount"
                                                   class="form-control">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn bg-primary">Deposit</button>
                            </div>
